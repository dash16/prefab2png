...
if args.mask:
	...
	print("✅ Defaulting to green zone logic: label mask not used unless --mask is set.")
...
if args.log_missing and missing_names:
	...
	print("ℹ️  No missing display names to log.")
